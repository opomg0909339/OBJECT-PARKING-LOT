                ...
                <div class="row">
                    ...
                    foreach ($rows as $r) {
                        ...
                        if ($r['STOPCAR'] == $car && $r['Stoppay'] == 0) {
                            ...
                            echo '<form method="post" action="center.php" style="display: inline;">';
                            echo '<button type="submit" class="btn btn-primary" value="' . $r["ID"] . '" name="pay">繳費</button>';
                            echo '</form>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
